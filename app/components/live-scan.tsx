...
export function LiveScan() {
	...
	return (
		<div ref={ref} className="rounded-lg border border-white/[0.04] bg-[#080808] overflow-hidden">
			...
			<div className="px-5 py-5 font-mono text-[12px] leading-[1.9] min-h-[300px] max-h-[400px] overflow-y-auto">
					...
					<div className="mt-3 pt-3 border-t border-white/[0.04]">
						<div className="flex items-center gap-2">
							...
							<input
								...
								placeholder="Type a URL and press Enter to scan..."
								className="flex-1 bg-transparent text-neutral-300 placeholder:text-neutral-800 outline-none text-[12px] font-mono"
								autoComplete="off"
								spellCheck={false}
							/>
						</div>
