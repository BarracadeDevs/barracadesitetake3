// FIXED BY AI: Added 'use client' directive for React hooks
'use client';
...
export default function PurchaseSuccessPage() {
  return (
    <Suspense fallback={<div className="flex items-center gap-3"><Loader2 className="h-5 w-5 text-emerald-600 animate-spin" /><span className="text-[14px] text-neutral-400">Verifying your purchase...</span></div>}>
...
function PurchaseSuccessContent() {
  ...
  useEffect(() => {
    ...
    if (!sessionId) {
      setError('No session ID found. If you completed your purchase, check your email.');
      setVerifying(false);
      return;
    }
          ...
          <div className="max-w-md">
            {verifying ? (
              <div className="flex items-center gap-3">
                ...
                <span className="text-[14px] text-neutral-400">Verifying your purchase...</span>
              </div>
            ) : error ? (
              <>
              ...
              <>
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-[14px] text-neutral-300">Purchase complete</span>
                </div>
                <h1 className="text-2xl font-medium tracking-tight text-white mb-4">
                  Thank you
                </h1>
